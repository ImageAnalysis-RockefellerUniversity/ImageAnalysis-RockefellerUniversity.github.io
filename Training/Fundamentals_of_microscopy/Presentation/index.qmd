...
## 
:::{.absolute top="50%" left="50%" style="transform: translate(-50%, -50%); font-size: 1.6em; width: 100%; color: #002fff; text-align: center;"}
Can you tell which images are the [same]{.text-red} and which are [different]{.text-red}?
:::
...
::: {.tight-grid layout-ncol="3" layout-nrow="2"}
...
![](images/F-actin_phalloidin_MTLn3_MEF/SS_MEF-1_BC.png){.overlay-img .fragment}
:::

::: {.img-stack}
![](images/F-actin_phalloidin_MTLn3_MEF/SS_MEF-3.png){.base-img}
![](images/F-actin_phalloidin_MTLn3_MEF/SS_MEF-3_BC.png){.overlay-img .fragment}
:::
...
## Changing image bit-depth {.smaller}
