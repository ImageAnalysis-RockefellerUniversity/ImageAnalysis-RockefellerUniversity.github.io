...
## 
:::{.absolute top="50%" left="50%" style="transform: translate(-50%, -50%); font-size: 1.8em; width: 100%; color: #002fff; text-align: center;"}
Part 2<br><br>What is an image and how to analyze it.
:::

## Why should I learn about images and analysis in an era of AI and Deep Learning?

<br>
![](images/AIDeBlur2.jpg){fig-align="center"}
...
## Image display vs intensity measurements
Histogram Brightness and Contrast LUT

Are these images different?

::: {layout="[1,1]"}
![Image 1](images/dew-maple-leaf-1974425.jpg)
![Image 2](images/dew-maple-leaf-1974425_BCwindow.jpg)
:::

Display wise: YES
Intensity measurement wise: NO

Left image is good for making figure panel.
Both images are identical in terms of pixel intensity values, so any of those can be used for intensity measurement and  quantitative analysis.

## Changing image bit depths {.smaller}
...
[in Fiji, go to `Edit > Options > Conversions...`]{.fragment}
